...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div ref={footerCardRef} className="relative z-10 flex min-h-[420px] w-full max-w-[1200px] translate-y-[calc(200vh-24px)] flex-col overflow-hidden rounded-[2rem] bg-ink-800 px-8 pb-12 pt-10 font-body text-text-hi shadow-2xl md:min-h-[560px] lg:px-12">
