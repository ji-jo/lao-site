...
export const DOCK_COLORS_MIN = 390; // at or above: show the colour palette, including common mobile widths
export const DOCK_PENS_MIN = 320; // at or above: show the pens (below: nav + links only)
